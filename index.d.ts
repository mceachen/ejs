// Type definitions for @mceachen/ejs
// Based on @types/ejs by Simon Schick and Piotr Błażejewicz
...
/**
 * The opening delimiter for all statements. This allows you to clearly delineate
...
/**
 * The closing delimiter for all statements. This allows you to clearly delineate
 * the difference between template code and existing delimiters. (It is recommended
...
export interface Options {
     ...
     * @default ejs.escapeXML
     */
    escapeFunction?: EscapeCallback | undefined;
    ...
    /**
     * Whether to use legacy include behavior.
     *
     * @default true
     */
    legacyInclude?: boolean | undefined;
}
...
export interface Cache {
    ...
    /**
     * Clear the entire cache (lru-cache v7+ compatibility).
     */
    clear?(): void;
}
 ...
 * Express.js support.
 *
 * This is an alias for {@link renderFile}, in order to support
 * Express.js out-of-the-box.
 */
export { renderFile as __express };
